...
// TODO: the real Ollie URL, or swap the click handler for the embed's open call
const BOT_URL = "#";
    ...
    <div className="ollie" id="ollie">
      ...
      <div className="ollie-row">
        ...
        <a
          ...
          onClick={(e) => {
            if (BOT_URL === "#") e.preventDefault();
            hidePreview();
          }}
        >
          <span className="ollie-av" aria-hidden="true">O</span>
          <span className="ollie-fab-label">Ask Ollie</span>
          <span className="ollie-dot" aria-hidden="true"></span>
        </a>
      </div>
      <span className="flag" style={{ marginTop: "6px" }}>Bot URL or embed snippet needed</span>
    </div>
  );
}
